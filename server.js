...
setInterval(() => {
  http.get(`http://sysletto.glitch.me/`);
}, 280000);
...
const dev = ["323133445352194048"]; ///تعديل مهم ايدي حسابك
const admin = "=";
var owner = "323133445352194048"; // Owner Bot Mention /// تعديل مهم ايدي حسابك
...
client.on("ready", () => {
  ...
  console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setActivity(`-help | Premium `, "http://twitch.tv/Letto"); ///تعديل مهم غير كلمة هيلب وبرميوم للوتشينق اللي بدك اياه مثل اسم سيرفرك
      ...
      .then(c => {
        ...
        const embed = new Discord.RichEmbed()
          ...
          .addField(
            ...
            `يرجى محاولة توضيح سبب فتح هذه البطاقة بأكبر قدر ممكن من التفاصيل. سيكون ** موظفو الدعم ** هنا قريبًا للمساعدة`
          )
          .setTimestamp();
        c.send({
          embed: embed
...
client.on("message", zaid => {
  if (zaid.content === "-bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@323133445352194048>`, true) // تعديل مهم عدل هذا الرقم لايدي حسابك
      .setImage(
        ""
      )
...
let room = "1148372951977181287"; //تعديل مهم ايدي روم عد الاعضاء والترحيب ، روم صوتي
...
client.on("message", message => {
  ...
  if (message.content === prefix + "3help") {
    ...
    message.author.sendMessage(`  **__Letto Bot v1__**
  **__أوامر الــمــوســيــقــى__**   
**  حاليا البوت ا يدعم الموسيقى ، اكتب  **
** - mhelp  **
...
client.on("guildCreate", guild => {
  var embed = new Discord.RichEmbed().setImage(
   ...
   ✽ **Support Server** [ • https://discord.gg/UxR6RGX • ]  ✽ `); //تعديل مهم رابط سيرفرك
